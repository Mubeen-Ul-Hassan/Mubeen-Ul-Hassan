...
[![My Skills](https://skillicons.dev/icons?i=html,css,js,jquery,react,sass,tailwind,nextjs,nodejs,express,fastapi,laravel,php,c,cpp,py,go,mongodb,mysql,postgres,redis,nginx,vercel,aws,git,github,githubactions,postman,vim,neovim,sentry,figma,linux,ubuntu,bash,md)](https://skillicons.dev)
